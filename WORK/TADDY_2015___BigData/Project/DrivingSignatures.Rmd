...
getDoParWorkers()
#clean_velocity_data_for_all_driver_trips(superfolder_path)
...
```{r}
d_1_3 <- calc_trip_data(read_driver_trip(data_folder_path, 1, 3))
...
This problem is very pervasive, present in over 25,000 driving trip data sets. Also, nearly 100% of the over 2,700 drivers have trips with missing data.
...
```{r}
d_1_83 <- calc_trip_data(read_driver_trip(data_folder_path, 1, 83))
...
```{r}
d_3000_21 <- calc_trip_data(read_driver_trip(data_folder_path, 3000, 21))
d_3000_21_corrected <- clean_velocity_data(d_3000_21)
p1 <- plot_trip(d_3000_21[261 : 500], 1, title = "Dr#3000 T#21 - missing data",
          color = "blue")
...
```{r}
d_20_170 <- calc_trip_data(read_driver_trip(data_folder_path, 20, 170))
d_20_170_corrected <- clean_velocity_data(d_20_170)
p1 <- plot_trip(d_20_170[701 : 890], 1, title = "Dr#20 Tr#170 - missing data",
          color = "blue")
p2 <- plot_trip(d_20_170_corrected[701 : 1500], 1, title = "Dr#20 Tr#170 - interpolated",
          color = "blue")
multiplot(p1, p2, cols = 2)
```
...
```{r}
d_20_13 <- calc_trip_data(read_driver_trip(data_folder_path, 20, 13))
d_20_13_corrected <- clean_velocity_data(d_20_13)
p1 <- plot_trip(d_20_13, 1.3, title = "Dr#20 Tr#13 - very corrupt data",
          color = "blue")
p2 <- plot_trip(d_20_13_corrected, 1.3, title = "Dr#20 Tr#13 - intepolated",
          color = "blue")
multiplot(p1, p2, cols = 2)
```
